...
public class GradeProgramPage extends GlobalVariable {
	...
	By coursetypegradeArrow = By.xpath("//input[@name = 'courseMaxMarkCombo']/../../td[2]");
	By minpassmarks = By.xpath("//input[@name = 'courseCutOff']");
	By maxpassmarks = By.xpath("//input[@name = 'courseMaxMark']");
	By minimumGrade = By.xpath("//input[@name = 'courseCutOffComboMin']/../../td[2]");
	By maximumGrade = By.xpath("//input[@name = 'courseCutOffComboMax']/../../td[2]");
	...
	By pbsaddbtn = By.xpath(
			"//div[contains(@data-xpath,'form_programbatchsectiongrid_programbatchsectiongrid')]//div[contains(@data-xpath,'programbatchsectiongrid_toolbar') and contains(@class,'top')]//a[@data-xpath='toolbar_btnAdd_button']");
	...
	By pbssearchbbtn = By
			.xpath("//div[contains(@id,'programbatchsectionsearch')]/table[4]//span[text()='Search']/ancestor::a");
	By pbssecaddbtn = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//a[@data-qtip='Add']//span[not(contains(text(),'Add Faculty'))]/ancestor::a[not(contains(@class,'left'))]");
	...
	By additonalreqYes = By.xpath(
			"//label[contains(text() , 'Additional Requirement:')]/../parent::td/div[contains(@class , 'box')]//label[text() = 'Yes']/../input");
	By assigncalenderexpand = By.xpath("//input[@name='calendar' and contains(@class,'noedit')]");

	By offeredacdloc = By.xpath("//input[@name='offeredAtAL']/../../td[2]");
	By batchnametxt = By.xpath("//input[@name='name']");
	By mngsecprgnametxt = By.xpath("//div[@name = 'programWiseProgram']/parent::td/../td[3]");
	By placementperiodnobtn = By.xpath(
			"//table[@data-xpath = 'radiogroup_whetherPlacementPeriod_radiofield']//label[text() = 'No']/../input");
	By periodstatudpdwarrow = By.xpath("//div[@name='periodStatus']/../../td[3]");
	By periodstatuvalue = By
			.xpath("//div[@data-xpath='multiselectcombofield_boundlist']//div[contains(@id, 'list')]//li/div[text() ='"
					+ GlobalVariable.periodStatus + "']/preceding-sibling::div");
	By doubleforword = By.xpath(
			"//input[contains(@name,'pageSizeCombo') and contains(@class,'form-text')]/ancestor::div[@data-xpath='selectionprocessgrid_header']//a[contains(@class,'double-forward')]");
	By selectAllSubject = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//div[contains(@id, 'programcourses')]//div[@data-xpath = 'programcoursesgrid_headercontainer']//div[@data-xpath = 'headercontainer_gridcolumn'][1]");
	By selectAllSubjectForMapping = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//div[@data-xpath = 'courseperiodmappinggrid_headercontainer']//div[@data-xpath = 'headercontainer_gridcolumn'][1]");

	By addButtonCourseParameter = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//a[@data-qtip='Add' and contains(@class ,'add')]");
	By addSectionDropdown = By.xpath("//input[@name = 'sectionCodeId']/../../td[2]");
	By courseranradio = By.xpath("//table[contains(@data-xpath,'radiogroup_courseRankConsidered')]/tbody//label[text()='Yes']/preceding-sibling::input");
	By sgpacgpaarrow = By.xpath("//input[@name='sgpaCgpaCalculationRule']/../../td[2]");
	...
	public void iFillBasicGradePrgDetails(String phasegroup, String category, String Evaluation, String Department,
		...
		BaseClass.writeInFile("ProgramBatch", GradeorProgramBatchName);
		GlobalVariable.programgrp = phasegroup;
		BaseClass.writeInFile("ProgramPhaseGroup", programgrp);
		try {
			CommonActions.clickOnElementAndType(GradeOrProgramCode, GradeorProgramBatchName, "Grade/Program code");
			BaseClass.writeInFile("Programcode", GradeorProgramBatchName);
		} catch (Exception e) {
		...
		BaseClass.writeInFile("ProgramName", GlobalVariable.GradeOrProgramName);
...
//		CommonActions.clickOnElementAndType(By.xpath("//input[@name='programSubMerchant']"), GlobalVariable.GradeOrProgramName, "Enter the Program sub merchant name");
	...
	public void iAddGradeIntakeDetails(String gradeperoidtype, String intakeyear, String assigncalender,
		...
		BaseClass.writeInFile("AssignCalender", assigncalender);

		CommonActions.clickOnElementAndType(batchnametxt, GlobalVariable.GradeOrProgramName, "Add Grade or Batch Name");

//		CommonActions.clickOnElementAndType(gradeprintname, GlobalVariable.GradeOrProgramName, "Add Grade or Batch Print Name");
...
//		CommonActions.clickOnElementAndType(minCGPA, "2", "min CGPA");
		...
		CommonActions.iClickElementByLocator(noRadioacconf, "Clicking Advance configuration No radio btn");
		try {
			CommonActions.iClickElementByLocator(assigncalendername, "Clicking Assign Calender arrow btn");
			Thread.sleep(4000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + assigncalender + " ']"),
					"Assign Calendername");

		} catch (Exception e) {
			System.out.println("Assign Calender name condition inside the Catch block ");
			WebElement ele = CommonActions.getElement(assigncalendername);
			CommonActions.iClickJSE(ele, "Clicking Assign Calender arrow btn");
//			CommonActions.iClickElementByLocator(assigncalenderexpand, "Clicking Assign Calender arrow btn");
			Thread.sleep(2000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + assigncalender + " ']"),
					"Assign Calendername");
		}

		CommonActions.iClickElementByLocator(additonalreqYes, "Additonal requirement yes radio");
	...
	public void iFetchGradeOrProgramNameAndClickGradeIntakeTab() throws InterruptedException {
		...
		BaseClass.writeInFile("ProgramIntakedetailsName", prgOrGradeNameIntakeDetails);
...
//		CommonActions.iClickElementByLocator(moredetails, "I Click More Details");
	...
	public void iCreateSeats(List<Map<String, String>> data) throws Exception {
		for (Map<String, String> type : data) {
			...
			BaseClass.writeInFile("Seatttype", seat);
	...
	public void iClickonAddPeriods(String rank, String year) throws Exception {
		...
		BaseClass.writeInFile("ProgramPeriodName", prgOrGradePeriodName);
...
//		CommonActions.clickOnElementAndType(periodenddate, CommonActions.getTodayDate("2024"), "Last date");
		...
		CommonActions.iClickElementByLocator(periodstatudpdwarrow, "i clicking period status dropdown arrow");
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(periodstatuvalue, "i clicking period status Value");

		CommonActions.iClickElementByLocator(enrolmentlastdate, "Enrolement End Date");
		new CommonLocatorPage().iClickButtonOfChoice("Today");

		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(offeredacdloc, "Clicking offered Academy location dropdown");
		Thread.sleep(2000);
		String str = GlobalVariable.academyLocation;
		BaseClass.writeInFile("AcademyLocation", academyLocation);
		String replacestr = str.replace("-", " - ");
		System.out.println("************Replaceed Academy location name is :  " + replacestr);
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'" + replacestr + "')]"),
				"Selecting the offered academy location ");

		CommonActions.iClickElementByLocator(placementperiodnobtn, "No Placement");
		Thread.sleep(2000);
...
//		GlobalVariable.Subname = subject;
	...
	public void iSearchedClass(String year, String marktype) throws Exception {
		...
		GlobalVariable.academicTerm = year;
		CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + year + " ']"),
...
//		CommonActions.clickOnElementAndType(gradeIntakeArrow, GlobalVariable.GradeOrProgramName, "Grade prg name");
		...
		CommonActions.iClickElementByLocator(mngsecprgnametxt, "Grade prg name Arrow");
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(
				By.xpath("//div[contains(text(),'" + GlobalVariable.GradeOrProgramName + "')]"), "Grade prg name");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(mngsecprgnametxt, "Grade prg name Arrow");
...
//		CommonActions.clickOnElementAndType(gradeIntakeArrow, GlobalVariable.GradeOrProgramName, "Grade prg name");
	...
	public void iAddClassDeatils() throws Exception {
		...
		BaseClass.writeInFile("ClassName/Section", classNames);
		Thread.sleep(2000);
		...
		CommonActions.iClickElementByLocator(By.xpath(
				"//table[@data-xpath='radiogroup_definedSection_radiofield']//label[contains(text(),'User-defined')]/../input"),
...
//		CommonActions.clickOnElementAndType(className, classNames, "class name");
	...
	public void iAddTeacherName(String teachername) throws Exception {
		BaseClass.writeInFile("Teachername", teachername);
	...
	public void AddCourseOrSubject(String type, String department, String minmarks, String maxmarks, String coursetype)
			throws Exception {
		...
		BaseClass.writeInFile("Coursecode", CoursesubjectCode);
		BaseClass.writeInFile("CourseName", CoursesubjectName);
		...
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + coursetype + " ']"),
				"option is " + coursetype + "");
...
//		CommonActions.iClickElementByLocator(By.xpath("//span[text() = 'Select Reports']/../../div[contains(@class , 'x-tool-before-title')]"),	"arrow");
	...
	public void ivalidateSectionsAppear() throws Exception {
		CommonActions.isDisplayed(By.xpath(
				"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//span[text() = 'Sections Associated' or text() = 'Classes Associated']"),
				"Section is visible");
	}

	public void iValidateCourseReport(String courcereportname) throws Exception {
		CommonActions.iClickElementByLocator(By.xpath("//span[contains(text(), '" + courcereportname + "')]/.."),
				"option is " + courcereportname + "");
	}

	public void iValidateCoursecomponentReport(String courcecomponentreportname) throws Exception {
		CommonActions.iClickElementByLocator(By.xpath(
				"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//div[@data-xpath = 'searchresultgrid_header']"),
				"option is " + courcecomponentreportname + "");
	}

	public void iSlectcoursereportSectionName() throws Exception {
		CommonActions.iClickElementByLocator(By.xpath(
				"//span[text() = 'Select Reports']/../../div[contains(@class , 'x-tool-before-title')] | //span[text() = 'Select Course Report']/../../div[contains(@class , 'x-tool-before-title')]"),
				"I Clicking the Arrow");
	...
	public void iAddPbsDetails(String homeroom, String teachername) throws Exception {
		...
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' " + homeroom + " ']"),
				"I Select HoomRoom Value is " + homeroom);
	...
	public void iClickAddSectionbtn() throws Exception {
		...
		CommonActions.iClickElementByLocator(
				By.xpath("//div[contains(text(),' " + GlobalVariable.PBSSectionName + " ')]"),
				"I Click on section arrow");
		new CommonLocatorPage().iClickSaveButton("window");
	...
	public void iSlectSectionNameFromFeeReportMenu(String name) throws Exception {
		CommonActions.iClickElementByLocator(
				By.xpath("//span[text()= '" + name + "' and contains(@class,'tree-node-text')]/.."),
				"option is " + name + "");

	}

	public void AddCourseOrSubjectwithGrade(String type, String department, String mingrade, String maxgrade,
		...
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text() ,'" + type + "')]"),
				"Select Subject Type Marks or Grade");
		CommonActions.iClickElementByLocator(coursetypegradeArrow, "Clicking course type drodown arrow");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' "+coursetype+" ']"),
				"option is " + coursetype + "");
		
		CommonActions.iClickElementByLocator(courseranradio, "Clicking the Course Rank Radio Button");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(minimumGrade, "Clicking the Arror for Subject Min Grade");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(@class, 'x-boundlist-floating') and not(contains(@style, 'display') )]//div[contains(text(),'"+mingrade+"')]"), "Enter Subject Min Grade");
	
		CommonActions.iClickElementByLocator(maximumGrade, "Clicking the Arror for Subject Max Grade");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(@class, 'x-boundlist-floating') and not(contains(@style, 'display') )]//div[contains(text(),'"+maxgrade+"')]"), "Enter Subject Max Grade");
		
		CommonActions.iClickElementByLocator(saveButton, "Clicking on Save Button");

	}

	public void AddCourseOrSubjectMultiple(String type, String department, String minmarks, String maxmarks,
			String coursetype, String numberofcourses) throws Exception {
		...
		for (int i = 1; i <= coursenumber; i++) {
			CommonActions.iImplicitlywait(30, "waitung...");
			Thread.sleep(4000);
			new CommonLocatorPage().iClickActionButton("Add");
			CoursesubjectCode = CommonActions.randomSubjectCourseGeneration();
			CoursesubjectName = CommonActions.randomSubjectCourseCodeGeneration();
			courseslist.add(CoursesubjectName);
			BaseClass.writeInFile("Coursecode", CoursesubjectCode);
			BaseClass.writeInFile("CourseName", CoursesubjectName);

			CommonActions.clickOnElementAndType(courseCode, GlobalVariable.CoursesubjectCode, "Enter Course code Name");
			CommonActions.clickOnElementAndType(courseName, GlobalVariable.CoursesubjectName,
	...
	public void iAddMultipleSubjectsinProgram() throws InterruptedException {
		CommonActions.iClickElementByLocator(addSubjectPrg, "I Click On Add Subjects");
		CommonActions.iClickElementByLocator(codeOrNameDropdown, "Course/SUbject name dropdown");
		Thread.sleep(3000);
		for (String coursename : GlobalVariable.courseslist) {
			CommonActions.iClickElementByLocator(By.xpath("//div[contains(text() , '" + coursename + "')]"),
					"Clicked subject");
			Thread.sleep(1000);
		}
		CommonActions.iClickElementByLocator(codeOrNameDropdown, "Course/SUbject name dropdown");
	...
	public void selectMultipleCOurses() throws InterruptedException {
		CommonActions.iClickElementByLocator(selectAllSubject, "subject to be mapped is selected");
	}

	public void iClickMapPeriodButtonAndMappedForMultipleSubjetcs() throws InterruptedException {
		CommonActions.iClickElementByLocator(mapPeriodButton, "Map period");
		CommonActions.iClickElementByLocator(selectAllSubjectForMapping, "Subject period row for mapping");
		int size = GlobalVariable.courseslist.size();
		System.out.println("**************List size of course is " + size);
		for (int i = 1; i <= size; i++) {
			CommonActions.iClickElementByLocator(By.xpath(
					"//div[contains(@id, 'courseperiodmapping')]//tr[contains(@role,'row')][" + i + "]/td[3]//img"),
					"Checkbox");
			Thread.sleep(1000);
		}
		CommonActions.iClickElementByLocator(selectAllSubjectForMapping, "Subject period row for mapping");
	...
	public void iAddClassDeatilsForMultipleSubjects() throws Exception {
		classNames = CommonActions.randromClassesNameGeneretor();
		BaseClass.writeInFile("ClassName/Section", classNames);
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath(
				"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//div[@data-xpath = 'managecoursesectionsummaryviewgrid_headercontainer']//div[@data-xpath = 'headercontainer_gridcolumn'][1]"),
...
//		CommonActions.clickOnElementAndType(className, classNames, "class name");
	...
	public void iClickonMapGradePeriodForMultiplecourses() throws Exception {
		CommonActions.iClickElementByLocator(By.xpath(
				"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//div[@data-xpath = 'managecoursesectionsummaryviewgrid_headercontainer']//div[@data-xpath = 'headercontainer_gridcolumn'][1]"),
				"Selecting all courses");
		CommonActions.iClickElementByLocator(mapgradeperiod, "Map Grade Period button");
	...
	public void iAddsubjectParameterandaddclassteacher(String teachername) throws Exception {
		CommonActions.iClickElementByLocator(addsubjectexpand, "Add Subject Parameter and Class teacher");
		WebElement sub = CommonActions.getElement(subjectname);
		Thread.sleep(4000);
		CommonActions.iScrollToTheElement(sub, "subject name dropdown");
		Thread.sleep(2000);
		System.out.println(GlobalVariable.courseslist);
		int numberofcourses = GlobalVariable.courseslist.size();
		for (int i = 0; i < numberofcourses; i++) {
			CommonActions.iClickElementByLocator(subjectname, "I Select subject Name Arrow");
			Thread.sleep(2000);
			CommonActions.iClickElementByLocator(By.xpath("//div[contains(text() , '"
					+ GlobalVariable.courseslist.get(i) + "') and contains(@class , 'item')]"), "I Select Subject");
			Thread.sleep(2000);
			try {
			CommonActions.iClickElementByLocator(
					By.xpath("//div[contains(@id , 'courseparameterassigngrid')]//div[contains(text() , '"
							+ GlobalVariable.courseslist.get(i) + "')]/../.."),
					"Select add teache rrow");
			Thread.sleep(3000);
				CommonActions.iClickElementByLocator(addclassteacher, "I Add Class Teacher");
				BaseClass.writeInFile("Teachername", teachername);
				...
				CommonActions.iClickElementByLocator(addButtonCourseParameter, "Add button to add section");
				CommonActions.iClickElementByLocator(addSectionDropdown, "Add section");
				Thread.sleep(2000);
				CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + GlobalVariable.classNames + " ']"),
						"Added section");
				new CommonLocatorPage().iClickSaveButton("window");
				CommonActions.iClickElementByLocator(
						By.xpath("//div[contains(@id , 'courseparameterassigngrid')]//div[contains(text() , '"
	...
	public void iAddingProgramBatchforGradeDetails(String gradeperoidtype, String intakeyear, String assigncalender,
			String calculation, String sgpacgparule) throws Exception {
		GlobalVariable.assignCalendar = assigncalender;
		BaseClass.writeInFile("AssignCalender", assigncalender);
...
//			CommonActions.iClickElementByLocator(assigncalenderexpand, "Clicking Assign Calender arrow btn");
		...
		CommonActions.iClickElementByLocator(sgpacgpaarrow, "Clicking Cgpa Sgpa dropdown arrow");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' "+sgpacgparule+" ']"), "Selecting the CGPA and SGPA Value");
		CommonActions.iClickElementByLocator(additonalreqYes, "Additonal requirement yes radio");
		CommonActions.clickOnElementAndType(additionaldetailstextarea, GlobalVariable.GradeOrProgramName,
				"Additional Details Textarea");
