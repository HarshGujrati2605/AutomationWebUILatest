...
public class FeeandPaymentPages extends GlobalVariable {
	...
	By nextreplacearrowclick = By.xpath(
			"//div[contains(@id,'alprogramgrid') and contains(@class,'x-box-inner ')]//a[contains(@class,'first-forward-btn')]");
	By ruledropdownarrow = By.xpath("//input[@name='drools']/../../td[2]");
	By closefeeplantab = By.xpath("//span[text()='Fee Plan Details']/ancestor::a//span[@class='x-tab-close-btn']");
	By doubleforwardbtn = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//a[@data-xpath='container_lastButton_button' and contains(@class,'double')]");
	...
	public void iCreateFeePlan(String feepalntype, String currency) throws Exception {
		...
		BaseClass.writeInFile("Application Feeplan Name :  ", ApplcFeePlanName);
...
//		CommonActions.iClickElementByLocator(lastPage, "Last Page");
			...
			CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + ApplcFeePlanName + "']"),
					"Selecting the Feeplan Name is " + ApplcFeePlanName);
		} catch (Exception e) {
			CommonActions.iClickElementByLocator(doubleforwardbtn, "Double click for the Extream last Page");
			Thread.sleep(3000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + ApplcFeePlanName + "']"),
					"Selecting the Feeplan Name is " + ApplcFeePlanName);
		}
...
//		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'"+Status+"')]"), "Status is " + Status + "");	
		...
		if (GlobalVariable.ApplFeeplanDescp1 == null) {
			...
			BaseClass.writeInFile("Application Feeplan Description1 :  ", ApplFeeplanDescp1);
		} else {
			ApplFeeplanDescp2 = descrptions;
			BaseClass.writeInFile("Application Feeplan Description2 :  ", ApplFeeplanDescp2);
		}
	...
	public void iMapFeePlan(String location, String seat) throws Exception {
		...
		CommonActions.iImplicitlywait(30, seat);
...
//		CommonActions.iClickElementByLocator(nextreplacearrowclick, "I click next Replace arrow ");
	...
	public void iCreateProgramFeePlan(String feepalntype, String currency) throws Exception {
		...
		BaseClass.writeInFile("Program Feeplan Name :  ", ProgramFeePlanName);
...
//		CommonActions.iClickElementByLocator(lastPage, "Last Page");
	...
	public void iSelectStatusStageDueDaysPrgFeePlan(String Status, String stage, String duedays, String descrptions)
		...
		if (GlobalVariable.PrgFeeplanDescp1 == null) {
			...
			BaseClass.writeInFile("Program Feeplan Description1 :  ", PrgFeeplanDescp1);
			
		} else {
			PrgFeeplanDescp2 = descrptions;
			BaseClass.writeInFile("Program Feeplan Description1 :  ", PrgFeeplanDescp2);
		}
        Thread.sleep(3000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' " + stage + " ']"), "stage is " + stage + "");
		CommonActions.clickOnElementAndType(dueDays, duedays, "Due days value is " + duedays + "");
	...
	public void iSelectCreatedProgramFeePlanforApprove() throws InterruptedException {
		...
		CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + GlobalVariable.ProgramFeePlanName + "']"),
				GlobalVariable.ProgramFeePlanName);
	}
	...
	public void iSelectStatusStageDueDaysPrgFeePlanDomicile(String Status, String stage, String duedays,
			String descrptions) throws Exception {
		...
		if (GlobalVariable.PrgFeeplanDescp3 == null) {
			...
			BaseClass.writeInFile("Domicile Program Feeplan Description1 ", PrgFeeplanDescp3);
		} else {
			PrgFeeplanDescp4 = descrptions;
			BaseClass.writeInFile("Domicile Program Feeplan Description2 ", PrgFeeplanDescp4);
		}
	...
	public void iSelectExamFeePlan(String feepalntype, String currency) throws Exception {

		ExamRevaluationName = CommonActions.randromExamFeePlanNameGenerator();
		BaseClass.writeInFile("Examination Feeplan Name ", ExamRevaluationName);
		CommonActions.clickOnElementAndType(Feeplan, ExamRevaluationName, "Enter the Exam feeplan name");
		CommonActions.iLogMessage("******" + ExamRevaluationName);
		CommonActions.selectionOptionFromDropdownAfterEntering(feeplantype, feepalntype);
		CommonActions.selectionOptionFromDropdownAfterEntering(currencyDropdown, currency);
		new CommonLocatorPage().iClickSaveButton("window");
	}

	public void ISelectexamFeePlan() throws InterruptedException {
		try {
			Thread.sleep(4000);
//		CommonActions.iClickElementByLocator(lastPage, "Last Page");
			CommonActions.iClickElementByLocator(lastpagedropdown, "Last Page");
			CommonActions.iClickElementByLocator(By.xpath("//li[text()='500']"), "Selecting the Last Feeplan");
			Thread.sleep(3000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + ExamRevaluationName + "']"),
					"Selecting the Feeplan Name is " + ExamRevaluationName);
		} catch (Exception e) {
			CommonActions.iClickElementByLocator(doubleforwardbtn, "Double click for the Extream last Page");
			Thread.sleep(3000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + ExamRevaluationName + "']"),
	...
	public void iSelectExamFeeplanStatusStageDueDays(String Status, String stage, String duedays, String descrptions)
			throws Exception {
		CommonActions.iClickElementByLocator(statusArrow, "Satus dropdown");
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' " + Status + " ']"), "Status is " + Status + "");
//		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'"+Status+"')]"), "Status is " + Status + "");	
	...
	public void iSelectExamFeePlanforApprove() throws InterruptedException {
		Thread.sleep(4000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + ExamRevaluationName + "']"),
				ExamRevaluationName);
	}

	public void iClodeFeeDetailsTabandChooseManageFeeplanTab() throws InterruptedException {
		CommonActions.iClickElementByLocator(closefeeplantab, "Closeing the Feeplan details tab");
		Thread.sleep(3000);
//		CommonActions.iClickElementByLocator(manageFeePlanTab, "Manage fee plan tab");
	}

	public void iSelectExamFeePlanforApply() throws InterruptedException {
		Thread.sleep(4000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text()='" + ExamRevaluationName + "']"),
				ExamRevaluationName);
	}
