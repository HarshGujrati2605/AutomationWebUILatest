...
import com.serosoft.base.ExcelDataSupplier;
...
public class AdmissionPage extends GlobalVariable {
	...
	By lastpagedropdown = By
			.xpath("//input[contains(@name,'pageSizeCombo') and contains(@class,'form-text')]/../../td[2]");
	...
	By feeplanarrrow = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//input[@name='feePlan']/../../td[2]");
	By feeplanrulearrow = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//input[@name='feePlanRule']/../../td[2]");
	By feeplanrulestagearrow = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//input[@name='feePlanRuleStage']/../../td[2]");
	...
	By paymentcurrencydropdown = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//input[@name='paymentCurrency']/../../td[2]");
	...
	By refundapplsearchbtn = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//span[text() = 'Search']/..");
	By finalapplidtxt = By.cssSelector("input[name='ADMISSION_NUMBER']");

	By coursesecradio = By.xpath("//label[text() = 'Course Section']/ancestor::td/input");
	By prgnamearrow = By.xpath("//input[@name = 'cbsProgram']/../../td[2]");
	By searchprgbtn = By.xpath(
			"//span[text()='Search' and @class='x-btn-inner x-btn-inner-center']/ancestor::a[@data-xpath='fieldcontainer_cbsEnrollSearchBtn_button']");
	By curseenrollbtn = By.xpath("//span[text() = 'Course Enrollment' or text()='Module Enrollment']/ancestor::a");
	By studenrollbtn = By.xpath("//span[text() = 'Student Enrollment']/ancestor::a");
	By enrollbtn = By.xpath(
			"//body/div[contains(@class, 'contentPanel')]/div[contains(@class, 'x-panel-body')]/div[not(contains(@style,'display: none')) and contains(@class,x-panel)]//div[contains(@contains,x-tabpanel-child)]//div[contains(id,tabpanel)]/div[not(contains(@style,'display: none')) and contains(@class, 'x-tabpanel-child')]//span[text() = 'Enroll']/ancestor::a");
	By doubleforword = By.xpath("//input[contains(@name,'pageSizeCombo') and contains(@class,'form-text')]/ancestor::div[@data-xpath='selectionprocessgrid_header']//a[contains(@class,'double-forward')]");
	By acadtermdpdwarrow = By.xpath("//table[@data-xpath='fieldcontainer_academicTerm_academicTerm_customcombobox' and contains(@class,'dirty')]//input[@name='academicTerm']/../../td[2]");
	...
	public void iAddtheSelectionProcess(String type) throws Exception {
		...
		BaseClass.writeInFile("Selection Process Feeplan Name ", selectionProcess);
	...
	public void iClickSelectionProcess() throws Exception {
		try {
			...
			CommonActions.iClickElementByLocator(
					By.xpath("//div[text()='" + GlobalVariable.selectionProcess + "']/../.."),
					"Selected Selection Process Name");
		} catch (Exception e) {
			CommonActions.iClickElementByLocator(doubleforword, "Last Page using double forword button");
			Thread.sleep(3000);
			CommonActions.iClickElementByLocator(
					By.xpath("//div[text()='" + GlobalVariable.selectionProcess + "']/../.."),
					"Selected Selection Process Name");
	...
	public void iSelectStage(List<Map<String, String>> data) throws Exception {
		for (Map<String, String> type : data) {
			...
			if (GlobalVariable.stagename1 == null) {
				...
				BaseClass.writeInFile("Selection Process Stage1 Name ", stagename1);
			} else {
				GlobalVariable.stagename2 = stagename.trim();
				BaseClass.writeInFile("Selection Process Stage2 Name ", stagename2);
			}
...
//		new CommonLocatorPage().iSelectRow("1", "nested");
	...
	public void iSelectConfigureCombination() throws Exception {
		...
		BaseClass.writeInFile("Selection Process Seat Type Name ", seatType);
	...
	public void iSelectStageSettingTab(List<Map<String, String>> seattype) throws Exception {
		for (Map<String, String> seat : seattype) {
			...
			Thread.sleep(2000);
			try {
				System.out.println("************ Enter into Try Condition *****************");
				CommonActions.iClickElementByLocator(feeplanrulestagearrow, "Select Feeplan Rule Stage textbox Arrow");
				Thread.sleep(3000);
				WebElement ele = CommonActions.getElement(By.xpath("//div[text()= ' " + feeplanstage + " ']"));
				CommonActions.iClickJSE(ele, feeplanstage);

			} catch (Exception e) {
				System.out.println("************ Enter into Catch Condition *****************");
				CommonActions.iClickElementByLocator(By.xpath("//input[@name='approverAuthority']"),
						"Selecting ApproverAuthority textbox");
				Thread.sleep(3000);
				CommonActions.iClickElementByLocator(feeplanrulestagearrow, "Select Feeplan Rule Stage textbox Arrow");
				Thread.sleep(3000);
...
//		ApplicantFirstName = CommonActions.randromSelectApplicantLasttName();
		...
		BaseClass.writeInFile("Applicant LastName ", ApplicantLastName);
		...
		BaseClass.writeInFile("Applicant FirstName or Applicant Name ", ApplicantFirstName);
...
//		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'" + employeename + "')]"),"Select Student Name");
	...
	public void iSelectLocationandProgram() throws Exception {
		...
		CommonActions.iClickElementByLocator(By.xpath("//input[@name= 'programs']/../../td[2]"),
				"Select Program Name Arrow");
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(
				By.xpath("//div[contains(text(),'" + GlobalVariable.GradeOrProgramName + "')]"), "Select Program Name");
...
//		CommonActions.clickOnElementAndType(By.xpath("//input[@name= 'programs']"), GlobalVariable.GradeOrProgramName,"Select Program Name");
	...
	public void iAssignApllicationId() throws Exception {
		...
		BaseClass.writeInFile("Applicant Id ", ApplicationId);
...
//		CommonActions.iClickElementByLocator(By.xpath("//label[contains(text(),'Application Payment Pending')]/parent::td/input"), "I select the Application pending  checkbox");
	...
	public void iValidateStudentList() throws Exception {
		...
		BaseClass.writeInFile("Student Name ", studentName);
		Thread.sleep(2000);
		GlobalVariable.StudentId = new CommonLocatorPage().iSelectColumnAndGetText("1", "3", "nested").trim();
		BaseClass.writeInFile("Student Id ", StudentId);
		Thread.sleep(2000);
	...
	public void iAddCountryNationalityOtherDetails(String country, String nationality, String disabilites, String rule,
		...
		Thread.sleep(2000);
		CommonActions.clickOnElementAndType(By.xpath("//input[@name='leadOwner']"), "System",
				"Enter the Lead Owener Name");
		Thread.sleep(2000);
		CommonActions.clickOnElementAndType(By.xpath("//input[@name='pleaseChooseAfterReadingInfo']"), "System",
				"Enter the after reading info:");
...
//		CommonActions.iClickElementByLocator(By.xpath("//div[contains(@data-xpath,'nestedJsonCombo')][2]//div[text() = ' "+secondlanguage+" ']"), "Select Applicant Second Language Value");
	...
	public void iSelectreciptsforStudent(String recipttype, String reciptfor, String currency) throws Exception {
		...
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(By.xpath("//input[@name='receivingCurrency']/../../td[2]"),
...
//		CommonActions.clickOnElementAndType(reciptCurrency, currency, "Recipt Currency For " + currency);
	...
	public void iSelectpaymentforStudent(String paymenttype, String paymentfor, String amount, String currency)
		...
		CommonActions.iClickElementByLocator(By.xpath("//div[text()=' " + currency + " ']"),
...
//		CommonActions.iClickEnter(paymentCurrency);
	...
	public void iSelectreciptsListforStudent(String recipttype) throws Exception {
		...
		BaseClass.writeInFile("Student Receipt Number ", ReceiptId);
		Thread.sleep(3000);
	...
	public void iValidateApplicantsandRefundHeader() throws Exception {
		...
		CommonActions.isDisplayed(By.xpath("//div[text() = '" + GlobalVariable.ApplicationId + "']/../.."),
				"Validateing the Applicant");
	...
	public void iValidateFinalAdmissionLists() throws Exception {
		...
		new CommonLocatorPage().iClickButtonOfChoice("Search");
		Thread.sleep(3000);
		CommonActions.iClickElementByLocator(By.xpath("//a[text()='" + GlobalVariable.StudentId + "']/.."),
	...
	public void iValidateJobstateHistory(String jobname, String jobstatus) throws Exception {
		...
		CommonActions.iClickElementByLocator(jobstatedropdown, "Job state dropdown");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[text() = ' " + jobstatus + " ']"),
				"Job state is + " + jobstatus + "");
		CommonActions.iClickElementByLocator(jobsearchbtn, "Search button for Run Job");
		Thread.sleep(3000);
	}

	public void iEnrolledProgCourseSection() throws Exception {
		CommonActions.iClickElementByLocator(coursesecradio, "Selecting Course Section Radio button");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(acadtermdpdwarrow, "Selecting Academic Term");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(By.xpath("//div[contains(text() ,'" + GlobalVariable.academicTerm + "')]"),
				"Selecting the Academic Term");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(prgnamearrow, "Selecting Program name arrow in course section");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(
				By.xpath("//div[contains(text() ,'" + GlobalVariable.GradeOrProgramName + "')]"),
				"Selecting the Program Name");
		CommonActions.iClickElementByLocator(searchprgbtn, "Clicking Search btn");
		Thread.sleep(2000);
		CommonActions.iClickElementByLocator(
				By.xpath("//div[text() = '" + GlobalVariable.CoursesubjectName + "']/ancestor::tr"),
				"Selecting the Course name in the List");

	}

	public void iOpenCourseEnrollment() throws Exception {
		CommonActions.iClickElementByLocator(curseenrollbtn, "Clicking Course enrollment btn");
		CommonActions.iClickElementByLocator(
				By.xpath("//div[text() = '" + GlobalVariable.studentName + "']/ancestor::tr/td[1]"),
				"Selecting the in unenrolled list");
		CommonActions.iClickElementByLocator(enrollbtn, "Clicking the enroll button");
		new CommonLocatorPage().iClickYes();
//		new CommonLocatorPage().iValidateAlert();

	}

	public void iCreateNewApplicationUsingExcel() throws Exception {
		String apltype = "";
		...
		for (int i = 0; i < rows - 1; i++) {
			...
			ApplicantLastName = data[i][2].toString();
			gender = data[i][3].toString();
			sourceentry = data[i][4].toString();
			contact = data[i][5].toString();
			emailid = data[i][6].toString();
			program = data[i][7].toString();
			location = data[i][8].toString();
			programgroup =data[i][9].toString();
			System.out.println(apltype);
			System.out.println(ApplicantFirstName);
			System.out.println(ApplicantLastName);
			...
			CommonActions.iClickElementByLocator(By.xpath("//input[@name='salutation']/../../td[2]"),
					"I Select yhe Salutation dropdown");
			CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'Mr')]"),
					"I Selecting the Salutation");

			CommonActions.clickOnElementAndType(aplfirstname, ApplicantFirstName, "Select Applicant FirstName");
			CommonActions.clickOnElementAndType(By.xpath("//input[@name='lastName']"), ApplicantLastName,
					"I enter the student last name");
			CommonActions.iClickElementByLocator(applicantdob, "Applicant DOB");
			new CommonLocatorPage().iClickButtonOfChoice("Today");
			...
			Thread.sleep(2000);
			CommonActions.iClickElementByLocator(By.xpath("//div[text()=' +91 ']"), "Select Country Code");
			CommonActions.clickOnElementAndType(contactnumber, contact, "Enter Contact Number");
			CommonActions.clickOnElementAndType(contactmailid, emailid, "Enter Contact Number");
			CommonActions.iClickElementByLocator(programaddbtn, "I Click Add Button");
			...
			CommonActions.iClickElementByLocator(programgrouparrow, "Click Program group Arrow");
			Thread.sleep(2000);
			CommonActions.iClickElementByLocator(By.xpath("//div[contains(text(),'" + programgroup + "')]"),
					"Select Program Group Name");
			CommonActions.iClickElementByLocator(By.xpath("//input[@name= 'programs']/../../td[2]"),
					"Select Program Name Arrow");
			Thread.sleep(3000);
			CommonActions.iClickElementByLocator(
					By.xpath("//div[contains(text(),'" + program + "')]"), "Select Program Name");
...
//			CommonActions.clickOnElementAndType(By.xpath("//input[@name= 'programs']"), GlobalVariable.GradeOrProgramName,"Select Program Name");
			...
			CommonActions.iClickElementByLocator(addprogrambtn, "Select Add Program button");
			CommonActions.iClickElementByLocator(submitbtn, "Click on Submit and generate Form Number Button");
		    CommonActions.iClickElementByLocator(By.xpath("//span[text() = 'Manage Forms']/ancestor::a[contains(@class , 'tab')]/span[@class = 'x-tab-close-btn']"), "Close button");
		    new HomePage().iClickOnOption("Admissions");
			Thread.sleep(2000);
			new CommonLocatorPage().iClickModule("Create Application");
