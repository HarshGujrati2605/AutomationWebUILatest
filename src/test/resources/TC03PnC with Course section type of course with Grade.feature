...
Feature: PnC Scenarios with grade
  ...
  Scenario Outline: Create Subject/course
    ...
    And I fill the mandatory details for course or subject with grade of "<type>","<Department>","<Min Grade>","<Max Grade>","<course type>"
    Then I can see the successfull alert

    Examples: 
      | Modulename | Module             | Action | type  | Department | Min Grade | Max Grade | course type |
      #   | Subjects   | Grades & Subjects  | Add    | Marks | Academic Adv Grp |        35 |       100 |                     |
      | Courses    | Programs & Courses | Add    | Grade | Academic   | F         | A         | CBCS        |
  ...
  Scenario Outline: Add Grade/Program details
    ...
    Examples: 
      ...
      | Programs   | Programs & Courses | Add    | Manually   | Under Graduate | BTech    | Grade     | Academic Affairs | DIT-Dehradun EM test data1 | 10001111 |
  ...
  Scenario Outline: Create Prg or Grade intake details
    ...
    And I click on "<Action>" button
    And I add program or grade batch details with "<GradePeriodType>","<IntakeYear>","<AssignCalender>","<CalculationRule>","<SGPACGPA Rule>"
    Then I can see the successfull alert

    Examples: 
      | GradePeriodType | IntakeYear | AssignCalender  | CalculationRule              | Action |SGPACGPA Rule|
      | Yearly          |       2023 | Org Calendar    | Current Period CGPA and SGPA | Add    |Generic Rule |
  ...
  Scenario Outline: Manage subjects class or course section creation
    ...
    Examples: 
     ...
     # | Manage Subject Class  | Grades & Subjects  | Crawford Lonehill College Cal |         2023 | Marks            |
      | Manage Course Section | Programs & Courses | Org Calendar                  |         2023 | Grade            |

  @addsectionorclass
  Scenario: Add class or section
    Given I Click on add class and AssignCalender fill details
    Then I can see the course parameterization alert

  @mapgradeperiod
  Scenario: Manage course section Map grade period creation
    Given I Click on map grade period
    Then I can see the successfull alert
    And I refresh page
